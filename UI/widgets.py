...
class EntiteWidgets(QWidget):
    def __init__(self, parent):
        ...
        self.scroll.setStyleSheet(stylesheets.ProblemCreationSpriteSheets().getScrollerStylsheet())
        self.setLayout(self.layout)
...
class CreationEntite(QWidget):
    def __init__(self, parent, valeurs):
        ...
        self.entiteNom.setStyleSheet(stylesheets.ProblemCreationSpriteSheets().getTextEditStylesheet())
...
class CreationValeur(QWidget):
    def __init__(self, parent):
        ...
        self.textEdit.setStyleSheet(stylesheets.ProblemCreationSpriteSheets().getTextEditStylesheet())
        self.layout.addWidget(label)
